...
public class TestData {
	...
	public static void main(String[] args) throws LibrarySystemException {
		...
		//a.addAll(s.addAuthor("elsa", "berhe", "125", "hjk", "ghjk", "hgjn", "hj", "geology"));
		//a.addAll(s.addAuthor("abush", "berhe", "125", "hjk", "ghjk", "hgjn", "hj", "geology"));
		//s.addBook("900","java", 88, a);
		//System.out.println(da.readBooksMap());
		//System.out.println();
		//s.addMember("1008", "yahia", "abdujebar", "7202804924", "4th", "farfield", "iowa","1233");
		//System.out.println(da.readMemberMap());
